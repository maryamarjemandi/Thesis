...
path_out = Path.cwd()/'results'/'corniche'/'metrics'
...
# ---------------- Dataset/Dataloader ----------------
ds_real = ImageFolder('/l/users/maryam.arjemandi/RecentCornicheFetalUS/LabeledImages/train/', transform=pil2torch)
...
# --------------- Load Model ------------------
model = VAE.load_from_checkpoint('/home/maryam.arjemandi/Documents/medfusion/runs/2024_10_14_210632/last.ckpt')
model.to(device)
