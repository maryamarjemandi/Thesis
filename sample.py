...
if __name__ == "__main__":
    path_out = Path.cwd()/'results/samples'
    ...
    pipeline = DiffusionPipeline.load_from_checkpoint('/home/maryam.arjemandi/Documents/medfusion/runs/2024_10_22_185452/last.ckpt')
    pipeline.to(device)
